...
The new `AGENTS.md` in the repository checks many of the boxes from above and is hand-written for the most part. From it the agent knows that while it's expected to assist in writing technical, sharp content, generating new content from scratch cannot be endorsed.
