...
const PRODUCTS = [
    { title: 'Browse Architectures', icon: 'sap-icon://document-text' },
    { title: 'Architecture Validator', icon: 'ssap-icon://order-status' },
    { title: 'Community of Practice', icon: 'sap-icon://group' },
    { title: 'Solution Diagram Guidelines', icon: 'sap-icon://action-settings' },
];
