...
// @ts-ignore
import exploreSidebar from '../data/exploreSidebar.json';
            ...
            <div style={{ width: '100%', maxWidth: '1300px' }}>
                ...
                <FlexBox justifyContent="SpaceBetween" alignItems="Center" style={{ marginLeft: '10px', marginBottom: '20px' }}>
                    ...
                    <FlexBox alignItems="Center" style={{ gap: '10px' }}>
                        ...
                        <Button design={activeDirection === 'left' ? 'Emphasized' : 'Transparent'} icon="navigation-left-arrow" onClick={goPrevious} />
                        <Button design={activeDirection === 'right' ? 'Emphasized' : 'Transparent'} icon="navigation-right-arrow" onClick={goNext} />
                    </FlexBox>
                </FlexBox>
                ...
                >
                    ...
                    {groupedItems.map((group, index) => (
                        <div key={index} style={{ display: 'flex', flex: '0 0 auto', width: '100%', justifyContent: 'space-between' }}>
                            {group.map((item) => (
                                <div key={item.id} style={{ width: '410px', flexShrink: 0 }}>
                                    <DocCard item={item} />
                                </div>
                            ))}
                        </div>
