---
id: id-ra0028
slug: /ref-arch/uEJClYEE
sidebar_position: 28
title: 'tEsT FoR JulIan'
description: 'This is a default description.'
keywords: 
  - aws
  - azure
  - gcp
sidebar_label: 'tEsT FoR JulIan'
image: img/logo.svg
...
![drawio](drawio/diagram-navtcz5PJS.drawio)





![drawio](drawio/diagram-5dDtrZWQtl.drawio)
...
- [Basic Prompting](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/1) introduces the fundamentals of prompting foundation models by interacting with the Generative AI Hub, providing essential techniques for effective AI engagement within your SAP BTP application.
- [Semantic Search & Embeddings](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/2) demonstrates how to leverage vector representations in SAP HANA Cloud's Vector Engine for context-aware, meaning-based search.
- [Retrieval Augmented Generation](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/3) extends on how to support and ground generative AI with actual documents and data.
- [AI Agents](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/5) enable autonomous, adaptive execution of complex enterprise processes.
- [A2A Agent-to-Agent Interoperability](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/8) illustrates how multiple agents collaborate with the A2A protocol.
- [Agents for Structured Data](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/6) enable natural language queries into enterprise data for descriptive and prescriptive analytics.
- [Multi-Tenancy](https://architecture.learning.sap.com/docs/ref-arch/d31bedf420) explains the multi-tenant aspect for generative AI on SAP BTP.
- [Vibe Coding with Cline and SAP AI Core](https://architecture.learning.sap.com/docs/ref-arch/e5eb3b9b1d/10) explains how to setup and use Cline with SAP AI Core.
