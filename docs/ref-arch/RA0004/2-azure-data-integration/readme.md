...
For detailed step by step information and to try out the integration, visit the GitHub : [Connecting Microsoft Fabric (Synapse Warehouse or Lakehouse) to SAP Datasphere](https://github.com/SAP-samples/sap-bdc-explore-hyperscaler-data/blob/main/Azure/fabric-integration.md)