...
2. Choose your preferred contribution method:  
   - [Get Started with Quick Start](community/Guidelines/GetStarted/get-started-quickstart.md) – a no-code approach.  
   - [Get Started with VSCode (CLI)](community/Guidelines/GetStarted/get-started-vscode.md) – a code-based approach.  
