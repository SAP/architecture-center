...
2. Choose your preferred contribution method:  
   - [Get Started with Quick Start](Guidelines/get-started-quickstart.md) – a no-code approach.  
   - [Get Started with VSCode (CLI)](Guidelines/get-started-vscode.md) – a code-based approach.  
